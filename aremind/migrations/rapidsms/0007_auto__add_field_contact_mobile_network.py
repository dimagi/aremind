...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.mobile_network'
        db.add_column('rapidsms_contact', 'mobile_network', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.mobile_network'
        db.delete_column('rapidsms_contact', 'mobile_network')
    ...
    models = {
        ...
        'rapidsms.contact': {
            ...
            'password': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'False'}),
            'mobile_network': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'})
        },
