...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.password'
        db.add_column('rapidsms_contact', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.password'
        db.delete_column('rapidsms_contact', 'password')
