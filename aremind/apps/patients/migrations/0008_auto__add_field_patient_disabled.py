...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patient.disabled'
        db.add_column('patients_patient', 'disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patient.disabled'
        db.delete_column('patients_patient', 'disabled')
    ...
    models = {
        'patients.patient': {
            ...
            'date_enrolled': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 3, 2)'}),
