...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Broadcast.iteration_num'
        db.add_column('broadcast_broadcast', 'iteration_num', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Broadcast.iteration_num'
        db.delete_column('broadcast_broadcast', 'iteration_num')
    ...
    models = {
        'broadcast.broadcast': {
            ...
            'iteration_num': ('django.db.models.fields.IntegerField', [], {})
        },
