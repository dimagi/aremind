...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding fields
        db.add_column('adherence_patientsurvey', 'questions_answered', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))

    def backwards(self, orm):
        
        # Deleting fields
        db.delete_column('adherence_patientsurvey', 'questions_answered')
    ...
    models = {
        ...
        'adherence.patientsurvey': {
            ...
            'questions_answered': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
