...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding fields
        db.add_column('adherence_patientsurvey', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))
        db.add_column('adherence_patientsurvey', 'subject_number', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=20))
        db.add_column('adherence_patientsurvey', 'phone', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=32))
        db.add_column('adherence_patientsurvey', 'language', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=6))
        db.add_column('adherence_patientsurvey', 'mobile_network', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=50))
        db.add_column('adherence_patientsurvey', 'ask_password_response', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=160))
        db.add_column('adherence_patientsurvey', 'daily_question1_response', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=160))
        db.add_column('adherence_patientsurvey', 'daily_question2_response', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=160))
        db.add_column('adherence_patientsurvey', 'daily_question3_response', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=160))
        db.add_column('adherence_patientsurvey', 'daily_question4_response', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=160))
        db.add_column('adherence_patientsurvey', 'monthly_question1_response', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=160))
        db.add_column('adherence_patientsurvey', 'monthly_question2_response', self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=160))

    def backwards(self, orm):
        
        # Deleting fields
        db.delete_column('adherence_patientsurvey', 'start_date')
        db.delete_column('adherence_patientsurvey', 'subject_number')
        db.delete_column('adherence_patientsurvey', 'phone')
        db.delete_column('adherence_patientsurvey', 'language')
        db.delete_column('adherence_patientsurvey', 'mobile_network')
        db.delete_column('adherence_patientsurvey', 'ask_password_response')
        db.delete_column('adherence_patientsurvey', 'daily_question1_response')
        db.delete_column('adherence_patientsurvey', 'daily_question2_response')
        db.delete_column('adherence_patientsurvey', 'daily_question3_response')
        db.delete_column('adherence_patientsurvey', 'daily_question4_response')
        db.delete_column('adherence_patientsurvey', 'monthly_question1_response')
        db.delete_column('adherence_patientsurvey', 'monthly_question2_response')
    ...
    models = {
        ...
        'adherence.patientsurvey': {
            ...
            'subject_number': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '20'}),
            'phone': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '32'}),
            'language': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '6'}),
            'mobile_network': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '50'}),
            'ask_password_response': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '160'}),
            'daily_question1_response': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '160'}),
            'daily_question2_response': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '160'}),
            'daily_question3_response': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '160'}),
            'daily_question4_response': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '160'}),
            'monthly_question1_response': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '160'}),
            'monthly_question2_response': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '160'})
        },
