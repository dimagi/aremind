...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reminder.end_date'
        db.add_column('adherence_reminder', 'end_date', self.gf('django.db.models.fields.DateField')(), keep_default=False)

        # Adding field 'Reminder.message'
        db.add_column('adherence_reminder', 'message', self.gf('django.db.models.fields.CharField')(max_length=160), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Reminder.end_date'
        db.delete_column('adherence_reminder', 'end_date')
        
        # Deleting field 'Reminder.message'
        db.delete_column('adherence_reminder', 'message')
